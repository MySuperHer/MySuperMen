...
function gobig(){
    ...
    if (do1 == age2){
        ...
        var g1x=g11*(1+g0/20)/24;
        var g2x=g21*(1+g0/20)/6;
        var g3x=g31*(1+g0/20)/6;
        var j1x=j11*(1+g0/20)/5;
        var l1x=l11*(1+g0/20)/5;
        var l2x=l21*(1+g0/20)/5;
        var i1x=i11*(1+g0/20)/5;
        var m1x=m11*(1+g0/20)/5;
        var hpx=10*(1+g0/20);
        ...
        content += '<div>體重成長了' + String(parseInt(g1+g2+g3)-parseInt(cg1-cg2-cg3)) + 'kg</div>';
        content += '<div>跳躍力成長了' + String(parseInt(j1)-parseInt(cj1)) + '</div>';
        content += '<div>視力成長了' + String(parseInt(l1)-parseInt(cl1)) + '</div>';
        content += '<div>幸運成長了' + String(parseInt(l2)-parseInt(cl2)) + '</div>';
        content += '<div>智力成長了' + String(parseInt(i1)-parseInt(ci1)) + '</div>';
        $("p").append(content);
    } else {
